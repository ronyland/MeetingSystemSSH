...
<link href="${path}/user/user.css" rel="stylesheet" type="text/css">
<link href="${path}/user/subscribe.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<div class="bodyright">
		...
		<div style="padding-left: 40px; font-size: 30px; font-weight: bold; color: #F00;">审核进行中，请耐心等候</div>
